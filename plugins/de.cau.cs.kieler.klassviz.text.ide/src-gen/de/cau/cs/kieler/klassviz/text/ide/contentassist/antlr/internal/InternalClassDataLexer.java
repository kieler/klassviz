...
public class InternalClassDataLexer extends Lexer {
    ...
    public final void mRULE_BOOLEAN() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalClassData.g:2076:14: ( ( 'true' | 'false' ) )
            // InternalClassData.g:2076:16: ( 'true' | 'false' )
            {
            // InternalClassData.g:2076:16: ( 'true' | 'false' )
            int alt1=2;
            ...
            switch (alt1) {
                case 1 :
                    // InternalClassData.g:2076:17: 'true'
                    {
                    match("true"); 
                    ...
                    break;
                case 2 :
                    // InternalClassData.g:2076:24: 'false'
                    {
                    match("false"); 
    ...
    public final void mRULE_TFLOAT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalClassData.g:2078:13: ( ( ( '+' | '-' ) ( ( '0' .. '9' )+ ( '.' ( '0' .. '9' )* )? ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )? | '.' ( '0' .. '9' )+ ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )? ) | ( '0' .. '9' )+ '.' ( '0' .. '9' )* ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )? | '.' ( '0' .. '9' )+ ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )? | ( '0' .. '9' )+ ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ ) )
            // InternalClassData.g:2078:15: ( ( '+' | '-' ) ( ( '0' .. '9' )+ ( '.' ( '0' .. '9' )* )? ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )? | '.' ( '0' .. '9' )+ ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )? ) | ( '0' .. '9' )+ '.' ( '0' .. '9' )* ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )? | '.' ( '0' .. '9' )+ ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )? | ( '0' .. '9' )+ ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )
            {
            // InternalClassData.g:2078:15: ( ( '+' | '-' ) ( ( '0' .. '9' )+ ( '.' ( '0' .. '9' )* )? ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )? | '.' ( '0' .. '9' )+ ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )? ) | ( '0' .. '9' )+ '.' ( '0' .. '9' )* ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )? | '.' ( '0' .. '9' )+ ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )? | ( '0' .. '9' )+ ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )
            int alt25=4;
            ...
            switch (alt25) {
                case 1 :
                    // InternalClassData.g:2078:16: ( '+' | '-' ) ( ( '0' .. '9' )+ ( '.' ( '0' .. '9' )* )? ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )? | '.' ( '0' .. '9' )+ ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )? )
                    {
                    ...
                    // InternalClassData.g:2078:26: ( ( '0' .. '9' )+ ( '.' ( '0' .. '9' )* )? ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )? | '.' ( '0' .. '9' )+ ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )? )
                    int alt12=2;
                    ...
                    switch (alt12) {
                        case 1 :
                            // InternalClassData.g:2078:27: ( '0' .. '9' )+ ( '.' ( '0' .. '9' )* )? ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )?
                            {
                            // InternalClassData.g:2078:27: ( '0' .. '9' )+
                            int cnt2=0;
                            loop2:
                            do {
                                int alt2=2;
                                ...
                                switch (alt2) {
                            	case 1 :
                            	    // InternalClassData.g:2078:28: '0' .. '9'
                            	    {
                            	    matchRange('0','9'); 
                            ...
                            // InternalClassData.g:2078:39: ( '.' ( '0' .. '9' )* )?
                            int alt4=2;
                            ...
                            switch (alt4) {
                                case 1 :
                                    // InternalClassData.g:2078:40: '.' ( '0' .. '9' )*
                                    {
                                    match('.'); 
                                    // InternalClassData.g:2078:44: ( '0' .. '9' )*
                                    loop3:
                                    do {
                                        int alt3=2;
                                        ...
                                        switch (alt3) {
                                    	case 1 :
                                    	    // InternalClassData.g:2078:45: '0' .. '9'
                                    	    {
                                    	    matchRange('0','9'); 
                            ...
                            // InternalClassData.g:2078:58: ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )?
                            int alt7=2;
                            ...
                            switch (alt7) {
                                case 1 :
                                    // InternalClassData.g:2078:59: ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+
                                    {
                                    ...
                                    // InternalClassData.g:2078:80: ( '0' .. '9' )+
                                    int cnt6=0;
                                    loop6:
                                    do {
                                        int alt6=2;
                                        ...
                                        switch (alt6) {
                                    	case 1 :
                                    	    // InternalClassData.g:2078:81: '0' .. '9'
                                    	    {
                                    	    matchRange('0','9'); 
                            ...
                            break;
                        case 2 :
                            // InternalClassData.g:2078:94: '.' ( '0' .. '9' )+ ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )?
                            {
                            match('.'); 
                            // InternalClassData.g:2078:98: ( '0' .. '9' )+
                            int cnt8=0;
                            loop8:
                            do {
                                int alt8=2;
                                ...
                                switch (alt8) {
                            	case 1 :
                            	    // InternalClassData.g:2078:99: '0' .. '9'
                            	    {
                            	    matchRange('0','9'); 
                            ...
                            // InternalClassData.g:2078:110: ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )?
                            int alt11=2;
                            ...
                            switch (alt11) {
                                case 1 :
                                    // InternalClassData.g:2078:111: ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+
                                    {
                                    if ( input.LA(1)=='E'||input.LA(1)=='e' ) {
                                        input.consume();
                                    ...
                                    // InternalClassData.g:2078:132: ( '0' .. '9' )+
                                    int cnt10=0;
                                    loop10:
                                    do {
                                        int alt10=2;
                                        ...
                                        switch (alt10) {
                                    	case 1 :
                                    	    // InternalClassData.g:2078:133: '0' .. '9'
                                    	    {
                                    	    matchRange('0','9'); 
                    ...
                    break;
                case 2 :
                    // InternalClassData.g:2078:147: ( '0' .. '9' )+ '.' ( '0' .. '9' )* ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )?
                    {
                    // InternalClassData.g:2078:147: ( '0' .. '9' )+
                    int cnt13=0;
                    loop13:
                    do {
                        int alt13=2;
                        ...
                        switch (alt13) {
                    	case 1 :
                    	    // InternalClassData.g:2078:148: '0' .. '9'
                    	    {
                    	    matchRange('0','9'); 
                    ...
                    match('.'); 
                    // InternalClassData.g:2078:163: ( '0' .. '9' )*
                    loop14:
                    do {
                        int alt14=2;
                        ...
                        switch (alt14) {
                    	case 1 :
                    	    // InternalClassData.g:2078:164: '0' .. '9'
                    	    {
                    	    matchRange('0','9'); 
                    ...
                    // InternalClassData.g:2078:175: ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )?
                    int alt17=2;
                    ...
                    switch (alt17) {
                        case 1 :
                            // InternalClassData.g:2078:176: ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+
                            {
                            if ( input.LA(1)=='E'||input.LA(1)=='e' ) {
                                input.consume();
                            ...
                            // InternalClassData.g:2078:197: ( '0' .. '9' )+
                            int cnt16=0;
                            loop16:
                            do {
                                int alt16=2;
                                ...
                                switch (alt16) {
                            	case 1 :
                            	    // InternalClassData.g:2078:198: '0' .. '9'
                            	    {
                            	    matchRange('0','9'); 
                    ...
                    break;
                case 3 :
                    // InternalClassData.g:2078:211: '.' ( '0' .. '9' )+ ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )?
                    {
                    match('.'); 
                    // InternalClassData.g:2078:215: ( '0' .. '9' )+
                    int cnt18=0;
                    loop18:
                    do {
                        int alt18=2;
                        ...
                        switch (alt18) {
                    	case 1 :
                    	    // InternalClassData.g:2078:216: '0' .. '9'
                    	    {
                    	    matchRange('0','9'); 
                    ...
                    // InternalClassData.g:2078:227: ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )?
                    int alt21=2;
                    ...
                    switch (alt21) {
                        case 1 :
                            // InternalClassData.g:2078:228: ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+
                            {
                            if ( input.LA(1)=='E'||input.LA(1)=='e' ) {
                                input.consume();
                            ...
                            // InternalClassData.g:2078:249: ( '0' .. '9' )+
                            int cnt20=0;
                            loop20:
                            do {
                                int alt20=2;
                                ...
                                switch (alt20) {
                            	case 1 :
                            	    // InternalClassData.g:2078:250: '0' .. '9'
                            	    {
                            	    matchRange('0','9'); 
                    ...
                    break;
                case 4 :
                    // InternalClassData.g:2078:263: ( '0' .. '9' )+ ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+
                    {
                    // InternalClassData.g:2078:263: ( '0' .. '9' )+
                    int cnt22=0;
                    loop22:
                    do {
                        int alt22=2;
                        ...
                        switch (alt22) {
                    	case 1 :
                    	    // InternalClassData.g:2078:264: '0' .. '9'
                    	    {
                    	    matchRange('0','9'); 
                    ...
                    // InternalClassData.g:2078:296: ( '0' .. '9' )+
                    int cnt24=0;
                    loop24:
                    do {
                        int alt24=2;
                        ...
                        switch (alt24) {
                    	case 1 :
                    	    // InternalClassData.g:2078:297: '0' .. '9'
                    	    {
                    	    matchRange('0','9'); 
    ...
    public final void mRULE_NATURAL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalClassData.g:2080:14: ( ( '0' .. '9' )+ )
            // InternalClassData.g:2080:16: ( '0' .. '9' )+
            {
            // InternalClassData.g:2080:16: ( '0' .. '9' )+
            int cnt26=0;
            loop26:
            do {
                ...
                switch (alt26) {
            	case 1 :
            	    // InternalClassData.g:2080:17: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalClassData.g:2082:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalClassData.g:2082:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalClassData.g:2082:11: ( '^' )?
            int alt27=2;
            ...
            // InternalClassData.g:2082:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop28:
            do {
                int alt28=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalClassData.g:2084:10: ( ( '0' .. '9' )+ )
            // InternalClassData.g:2084:12: ( '0' .. '9' )+
            {
            // InternalClassData.g:2084:12: ( '0' .. '9' )+
            int cnt29=0;
            loop29:
            do {
                ...
                switch (alt29) {
            	case 1 :
            	    // InternalClassData.g:2084:13: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalClassData.g:2086:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalClassData.g:2086:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalClassData.g:2086:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt32=2;
            ...
            switch (alt32) {
                case 1 :
                    // InternalClassData.g:2086:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalClassData.g:2086:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop30:
                    do {
                        int alt30=3;
                    ...
                    break;
                case 2 :
                    // InternalClassData.g:2086:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalClassData.g:2086:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop31:
                    do {
                        int alt31=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalClassData.g:2088:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalClassData.g:2088:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalClassData.g:2088:24: ( options {greedy=false; } : . )*
            loop33:
            do {
                int alt33=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalClassData.g:2090:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalClassData.g:2090:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalClassData.g:2090:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop34:
            do {
                int alt34=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalClassData.g:2092:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalClassData.g:2092:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalClassData.g:2092:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt37=0;
            loop37:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalClassData.g:2094:16: ( . )
            // InternalClassData.g:2094:18: .
            {
            matchAny(); 
    ...
    class DFA25 extends DFA {
        ...
        public String getDescription() {
            return "2078:15: ( ( '+' | '-' ) ( ( '0' .. '9' )+ ( '.' ( '0' .. '9' )* )? ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )? | '.' ( '0' .. '9' )+ ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )? ) | ( '0' .. '9' )+ '.' ( '0' .. '9' )* ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )? | '.' ( '0' .. '9' )+ ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )? | ( '0' .. '9' )+ ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )";
        }
    }
    ...
    static final String[] DFA38_transitionS = {
            "\11\30\2\27\2\30\1\27\22\30\1\27\1\30\1\24\4\30\1\25\1\12\1\13\1\30\1\20\1\14\1\20\1\15\1\26\12\21\3\30\1\4\3\30\32\23\3\30\1\22\1\23\1\30\1\23\1\3\1\7\1\11\1\10\1\17\2\23\1\1\6\23\1\2\3\23\1\16\6\23\1\5\1\30\1\6\uff82\30",
            "\1\31\1\32",
            "\1\35\20\uffff\1\34",
            "\1\36",
            "",
