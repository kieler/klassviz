...
public class ClassDataStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new de.cau.cs.kieler.klassviz.text.ClassDataRuntimeModule());
	}
	...
	public void register(Injector injector) {
		...
		org.eclipse.xtext.resource.IResourceServiceProvider.Registry.INSTANCE.getExtensionToFactoryMap().put("klaviz", serviceProvider);
