...
public class ClassdataPackageImpl extends EPackageImpl implements ClassdataPackage {
	 ...
	 * @generated
	 */
    public EAttribute getKClassModel_Metamodels() {
		return (EAttribute)kClassModelEClass.getEStructuralFeatures().get(5);
	}
	 ...
	 * @generated
	 */
	public EReference getKTypeReference_TypeParameters() {
		return (EReference)kTypeReferenceEClass.getEStructuralFeatures().get(3);
	}
    ...
    public void createPackageContents() {
		...
		createEAttribute(kClassModelEClass, KCLASS_MODEL__METAMODELS);
		...
		createEReference(kTypeReferenceEClass, KTYPE_REFERENCE__TYPE_PARAMETERS);
    ...
    public void initializePackageContents() {
		...
		initEAttribute(getKClassModel_Metamodels(), ecorePackage.getEString(), "metamodels", null, 0, -1, KClassModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getKTypeReference_TypeParameters(), this.getKTypeReference(), null, "typeParameters", null, 0, -1, KTypeReference.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
